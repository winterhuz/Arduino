...
double ReadVoltage(byte A0){
  double reading = analogRead(A0); // Reference voltage is 3v3 so maximum reading is 3v3 = 4095 in range 0 to 4095
...
void Thermistor(int16_t ADCvalue)
{
  ...
  int16_t V = ReadVoltage(A0); // ADC accuracy improved for ESP32
